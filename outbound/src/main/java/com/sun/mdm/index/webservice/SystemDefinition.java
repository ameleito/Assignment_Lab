...
public class SystemDefinition {
    ...
    public static class Properties {
        ...
        protected List<SystemDefinition.Properties.Entry> entry;
         ...
         * 
         */
        public List<SystemDefinition.Properties.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<SystemDefinition.Properties.Entry>();
            }
            return this.entry;
        }
